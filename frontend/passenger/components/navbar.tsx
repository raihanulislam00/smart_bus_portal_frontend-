        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              {isLoggedIn ? (
                <>
                  <Link href="/passenger/dashboard" className="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition duration-300">
                    Dashboard
                  </Link>
                ...
                <>
                  <Link href="/passenger/login" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition duration-300">
                    Login
                  </Link>
                  <Link href="/passenger/signup" className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition duration-300">
                    Sign Up
                  </Link>
                </>
              )}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50">
              ...
              <div className="pt-4 pb-3 border-t border-gray-200">
                <div className="flex flex-col space-y-2">
                  {isLoggedIn ? (
                    <>
                      <Link href="/passenger/dashboard" className="text-gray-700 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">
                        Dashboard
                      </Link>
                    ...
                    <>
                      <Link href="/passenger/login" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 text-center">
                        Login
                      </Link>
                      <Link href="/passenger/signup" className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 text-center">
                        Sign Up
                      </Link>
                    </>
                  )}
